...
export default function OrderHistoryScreeen() {
  ...
  console.log('OrderListOrderList', OrderList?.data?.GTS);
    ...
    <View style={[tailwind('h-full bg-secondary')]}>
      ...
      >
        {OrderList?.data?.GTS?.filter(item => {
          const filterValue = item?.order_status;
          return filterValue === 0 || filterValue === 5;
