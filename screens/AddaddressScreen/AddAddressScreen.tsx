...
export default function AddAddressScreen() {
        ...
        try {
          ...
          if (route?.params?.user_address_id) {
            ...
            if (
              ...
              setLocalLocation({
                latitude: Number(selectedAddress.user_address_latitude),
                longitude: Number(selectedAddress.user_address_longitude),
    ...
    return (
      <View style={[tailwind('px-2')]}>
        <TextInput
          ...
          style={[
            tailwind(
              'bg-white rounded p-2 flex-grow font-bold text-black py-3',
            ),
          ]}
        />
      </View>
  ...
  return (
    <View style={[tailwind('h-full bg-secondary'), {}]}>
      <Topbar title={"Set Address"} type={3} />
